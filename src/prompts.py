...
feedback_prompt = ["As a nutrition coach with over 10 years of experience, I want you to evaluate my current meal. Write Meal Quality Assessment for me. Yesterday"], 
["Please let me know if I am eating right, and if not, provide advice on how I can improve my diet. Describe what is useful in my diet and what is not. Describe each meal briefly, in 1 sentence, no more than 25 words. Rate how healthy I eat on a scale of 1 to 10. If I got less than 10 points - help me, how can I increase this number? Structure the text so that it is easy to read. In response, use emoji where they are needed so that it is not boring. Write in Russian. Write in a playful, hilarious, supportive style."]
