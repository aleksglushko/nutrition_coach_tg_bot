...
finish_onboarding_message = "Поздравляю! Ты прошел онбординг! \nНадеюсь мой фидбек был полезным для тебя👩‍🔬\n\nЕсли ты захочешь снова получить от меня фидбек на твою еды и рекомендации, ты можешь отправить команду /get_feedback и написать, что ты съел.\n\n\
...
/ask_question - задать нутрициологу вопрос про питание.
/get_recipe - получить рецепт по названию.
/help - узнать про возможности бота.
/start - пройти онбординг заново, чтобы изменить свои ответы.
"""
